    ...
    <div class="page-header">
        <div class="page-block">
            <div class="page-header-title">
                <h5 class="mb-0 font-medium">Cat</h5>
            </div>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= base_url('/') ?>">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="javascript: void(0)">Cat</a></li>
        ...
        <tbody>
            ...
            foreach ($kendaraan as $item): ?>
                <tr>
                    ...
                    <td>
                        <button class="btn btn-sm btn-primary">LOLOS CAT</button>
        ...
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '/proses/mulai-poles/' + id;
                }
            });
        });
    });
