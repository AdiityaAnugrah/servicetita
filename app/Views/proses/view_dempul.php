    ...
    <div class="page-header">
        <div class="page-block">
            <div class="page-header-title">
                <h5 class="mb-0 font-medium">Dempulr</h5>
            </div>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= base_url('/') ?>">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="javascript: void(0)">Dempul</a></li>
                <li class="breadcrumb-item" aria-current="page">Denmpul</li>
            </ul>
        </div>
    </div>
        ...
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '/proses/mulai-cat/' + id;
                }
            });
        });
    });
