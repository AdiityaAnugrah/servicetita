    ...
    <div class="page-header">
        <div class="page-block">
            <div class="page-header-title">
                <h5 class="mb-0 font-medium">Mobil Siap Keluar</h5>
            </div>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= base_url('/') ?>">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="javascript: void(0)">Mobil Siap Keluar</a></li>
                <li class="breadcrumb-item" aria-current="page">Siap Keluar</li>
            </ul>
        </div>
    </div>
...
<script>
    document.querySelectorAll('.btn-bongkar').forEach(button => {
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                title: 'Apakah sudah yakin mobil keluar ?',
                icon: 'question',
                ...
                if (result.isConfirmed) {
                    window.location.href = '/proses/mulai-keluar/' + id;
                }
            });
        });
    });
